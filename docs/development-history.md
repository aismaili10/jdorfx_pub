...
- Implementation details and rationale: [Animation guide](animation-guide.md).
...
## How to Try
After installing dependencies (Full JDK 8, ooRexx 5, BSF4ooRexx850), run the
scripts as described in [Setup and testing](setup.md).
...
For implementation details, see the [Animation guide](animation-guide.md) and
the handler code at
