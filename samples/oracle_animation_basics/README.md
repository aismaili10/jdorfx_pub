...
| 3-2 Path Transition | `samples/oracle_animation_basics/Example_02_PathTransition.java` | `samples/oracle_animation_basics/Example_02_PathTransition.rxj` | Equivalent |
...
| 3-5 Basic Timeline | `samples/oracle_animation_basics/Example_05_BasicTimelineAnimation.java` | `samples/oracle_animation_basics/Example_05_BasicTimelineAnimation.rxj` | Equivalent |
| 3-7 Built-in Interpolator | `samples/oracle_animation_basics/Example_06_BuiltInInterpolator.java` | `samples/oracle_animation_basics/Example_06_BuiltInInterpolator.rxj` | Equivalent |
